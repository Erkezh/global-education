  ...
  <section class="py-24 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center max-w-3xl mx-auto">
        <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl">{{ t.about.title }}</h2>
        <p class="mt-4 text-xl text-gray-500">{{ t.about.description }}</p>
      </div>
      ...
      <div class="mt-20 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center hover:shadow-md transition-shadow">
          ...
          <h3 class="text-xl font-bold text-gray-900 mb-3">{{ t.about.items[0].title }}</h3>
          <p class="text-gray-500">{{ t.about.items[0].description }}</p>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center hover:shadow-md transition-shadow">
          ...
          <h3 class="text-xl font-bold text-gray-900 mb-3">{{ t.about.items[1].title }}</h3>
          <p class="text-gray-500">{{ t.about.items[1].description }}</p>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center hover:shadow-md transition-shadow">
          ...
          <h3 class="text-xl font-bold text-gray-900 mb-3">{{ t.about.items[2].title }}</h3>
          <p class="text-gray-500">{{ t.about.items[2].description }}</p>
        </div>
      </div>
    </div>
  </section>
